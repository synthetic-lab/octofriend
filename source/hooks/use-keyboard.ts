...
function useKeyboardImpl(callback: KeyboardListener, isActive = true): void {
...
export function useKeyboard(callback: KeyboardListener, isActive = true): void {
  keyboardDeps.useKeyboard(callback, useInputFocus(isActive));
}
