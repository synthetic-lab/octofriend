use octofriend_agent::runtime::{AGENTD_CONFIG_SELECT_MODEL_METHOD, handle_agentd_json_rpc_line};
use serde_json::json;
...
fn config_select_model_reports_missing_configured_env_auth() {
            ...
            "config": {
                "models": [
                    ...
                    },
                    {
                        ...
                        "apiEnvVar": "octofriend_MISSING_SWITCH_KEY_DO_NOT_SET",
                        "model": "custom-model",
                        "context": 200000
                    }
                ]
    ...
    assert_eq!(
        ...
        json!({
            ...
            "error": {
                "type": "missing",
                "message": "Environment variable octofriend_MISSING_SWITCH_KEY_DO_NOT_SET is not set"
            }
        })
    );
}
