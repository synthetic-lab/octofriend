...
pub(in crate::runtime) fn model_provider_key_from_name_response(
    ...
    match octofriend_config::models::key_from_name(&params.name) {
...
pub(in crate::runtime) fn model_provider_for_base_url_response(
    ...
    create_json_rpc_success(
        id,
        json!({ "provider": octofriend_config::models::provider_for_base_url(&params.base_url).map(provider_json) }),
    )
}
...
pub(in crate::runtime) fn model_recommended_model_response(
    ...
    let model = octofriend_config::models::recommended_model(provider.key);
...
fn model_provider_catalog_result_json() -> Value {
    ...
    json!({
        ...
        "defaultMultimodalImageModelExample": octofriend_config::models::DEFAULT_MULTIMODAL_IMAGE_MODEL_EXAMPLE,
    })
}
...
fn model_json(model: &octofriend_config::models::ProviderModelConfig) -> Value {
    ...
    if let Some(reasoning) = model.reasoning {
        object.insert(
            ...
            json!(match reasoning {
                octofriend_config::models::ReasoningLevel::None => "none",
                octofriend_config::models::ReasoningLevel::Minimal => "minimal",
                octofriend_config::models::ReasoningLevel::Low => "low",
                octofriend_config::models::ReasoningLevel::Medium => "medium",
                octofriend_config::models::ReasoningLevel::High => "high",
                octofriend_config::models::ReasoningLevel::XHigh => "xhigh",
                octofriend_config::models::ReasoningLevel::Max => "max",
                octofriend_config::models::ReasoningLevel::Ultra => "ultra",
            }),
        );
    }
