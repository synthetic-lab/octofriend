use octofriend_tools::runtime::{BuiltInToolDefinitionsInput, built_in_tool_definitions};
use octofriend_tools::skills::AgentSkill;
...
pub(in crate::runtime) fn tool_definitions_response(
    id: JsonRpcId,
    params: Option<Value>,
) -> JsonRpcResponse {
