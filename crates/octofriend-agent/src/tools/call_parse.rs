...
pub(in crate::runtime) struct ToolCallParseOneParams {
...
#[derive(Clone, Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::runtime) struct ToolCallParseToolParam {
    pub(in crate::runtime) index: u64,
    pub(in crate::runtime) id: Option<String>,
    pub(in crate::runtime) name: Option<String>,
    pub(in crate::runtime) arguments: Option<String>,
}

#[derive(Clone, Copy, Debug, Deserialize)]
#[serde(rename_all = "kebab-case")]
pub(in crate::runtime) enum ToolCallParseProviderParam {
...
#[derive(Clone, Debug, Deserialize)]
pub(in crate::runtime) struct ToolCallParseAvailableToolParam {
    pub(in crate::runtime) name: String,
    pub(in crate::runtime) schema: Value,
}

#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::runtime) struct ToolCallParseBatchParams {
    pub(in crate::runtime) provider: ToolCallParseProviderParam,
    pub(in crate::runtime) tools: Vec<ToolCallParseToolParam>,
    pub(in crate::runtime) available_tools: Vec<ToolCallParseAvailableToolParam>,
    pub(in crate::runtime) cwd: PathBuf,
    pub(in crate::runtime) output: Value,
    #[serde(default)]
    pub(in crate::runtime) autofixed_args_by_index: BTreeMap<String, Value>,
}

pub(in crate::runtime) fn tool_call_parse_batch_result_json(
...
fn tool_parse_input(
    provider: ToolCallParseProviderParam,
    tool: ToolCallParseToolParam,
) -> Result<octofriend_models::compiler::ToolParseInputItem, String> {
...
fn tool_parse_execution_result_json(request: &ToolParseExecutionRequest) -> Value {
    ...
    match result {
        octofriend_models::compiler::ToolParseExecutionResult::Success { tool } => json!({
            "status": "success",
            "tool": tool,
        }),
        octofriend_models::compiler::ToolParseExecutionResult::Error { message } => {
