...
use octofwen_models::providers::synthetic::QuotaData;
use octofwen_models::request_ir::LlmIr;
use octofwen_tools::runtime::ToolRegistry;
...
pub enum TrajectoryEvent {
    ...
    AutofixingDiff,
    ResponseProgress {
        buffer: octofwen_models::compiler::CompilerTokenBuffer,
