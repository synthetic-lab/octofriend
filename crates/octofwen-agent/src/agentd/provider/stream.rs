...
pub(in crate::agentd) fn provider_stream_events_json(events: &[ProviderStreamEvent]) -> Value {
...
pub(in crate::agentd) fn provider_stream_state_json(state: &ProviderStreamState) -> Value {
    json!({
