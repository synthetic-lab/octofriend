...
use octofwen_models::providers::anthropic::anthropic_messages_stream_events;
use octofwen_models::providers::gemini::gemini_generate_content_stream_events;
use octofwen_models::providers::openai::{
        ...
        && events.iter().any(|event| {
            matches!(
                ...
                ProviderStreamEvent::Token {
                    kind: octofwen_models::providers::stream::ProviderTokenKind::Tool,
                    ..
