...
use octofwen_workspace::local::{DirectoryEntry, LocalTransport, TransportError, TransportResult};
use octofwen_workspace::ssh::SshTransport;
use octofwen_workspace::workspace::{FindFilesEntryType, FindFilesOptions, find_files};
...
pub(super) fn transport_get_env_response(id: JsonRpcId, params: Option<Value>) -> JsonRpcResponse {
    ...
    result_response(
        id,
        octofwen_workspace::local::get_env_var(
            &transport,
            &params.name,
